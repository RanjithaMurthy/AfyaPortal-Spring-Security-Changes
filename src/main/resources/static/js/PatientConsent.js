...
PatientConsentModule.config(['$httpProvider', function($httpProvider) {
...
PatientConsentModule.controller('PatientConsentController', ['$scope', '$http', '$window', function($scope, $http, $window){
    ...
    angular.element(document).ready(function(){
        $http.get('/afya-portal/static/application-deployment.properties').then(function(response){
            ...
            $http.get('/afya-portal/anon/getPatientByUsername?username='+$scope.username).success(function(data){
                ...
                $http.get($scope.portalBaseURL + '/anon/getPatientConsentByUsername?username=' + $scope.username).success(function(data){
                    console.log(data);
    ...
    $scope.UpdatePatientConsent = function(){
        ...
        $http.post('/afya-portal/anon/updatePatientConsentForUsername?username=' + $scope.username, jsonObj, {headers: {'accept': 'text/plain'}}).success(function (data) {
