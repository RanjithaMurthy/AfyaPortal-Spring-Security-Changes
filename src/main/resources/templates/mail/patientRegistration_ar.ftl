                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">Dear ${firstName} ${lastName},</p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">
                                    This is Arabic Template. You created an account with the email address: ${sendTo}
                                    ...
                                    <a target="_blank" class="btn btn-primary" href="${confirmationUrl}">Confirm</a>
                                    <br/><br/>
                                    Can't see the button?
                                    Try this link: ${confirmationUrl}
                                    <br />
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> <strong>Community Care Team</strong><br /> </p>
                                </td>
                        </tr>
                    </table>		   </td>
            </tr>
