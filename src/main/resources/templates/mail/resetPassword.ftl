                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">Respected ${firstName} ${lastName},</p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">
                                    Click "Reset" to Reset your account password.
                                    <a target="_blank" class="btn btn-primary" href="${confirmationUrl}">Reset</a>
                                    <br/><br/>
