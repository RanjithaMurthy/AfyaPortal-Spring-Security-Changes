...
<table width="100%" border="0" cellpadding="20" style="background-color:#F4F4F4;">
    <tr>
        <td><table width="650" border="0" cellpadding="0" align="center" style="background-color:#FFFFFF; border:solid 1px #D8D8D8; border-top:solid 8px #99CC33;">
            <tr>
                <td colspan="3">
                    <h3 style="font-family:Arial, Helvetica, sans-serif; font-size:18px; margin:20px; margin-bottom:5px; color:#81AA2B;"><strong>Don't miss out !</strong></h3> </td>
            </tr>
            <tr>
                <td colspan="3">
                    ...
                    <table width="600" border="0" cellpadding="5" align="center">
                        <tr>
                            <td>
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px;">Respected ${afyaId}, ${firstName} ${lastName},</p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;">
                                    Thanks for registering at ${clinicName}, you have been provided with a secured Afya Health account. Please logon as Afya member using your user-name: ${userName} and password: ${password}. Please change your default password.
                                    <br/><br/>
                                    Thanks,
                                    <br/>
                                    ${clinicOwnerName}
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"></p>
                                <p style="font-family:Arial, Helvetica, sans-serif; font-size:14px; margin:3px; margin-bottom:9px; line-height:24px;"> <strong></strong><br /> </p>
                                </td>
                        </tr>
                    </table>		   </td>
            </tr>
