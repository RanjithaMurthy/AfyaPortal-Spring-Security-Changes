...
var username = $('#email_username').val();
        $.ajax({
        url :'/afya-portal/anon/getEmailId?username='+username,
        success : function(data){
        if(data == "success"){
        sweetAlert({
                                    title: "Success",
                                    text: "Reset link has sent to your registered email id",
                                    type: "success"//error
                                });
              }else{
              document.getElementById("errmsg").innerHTML ="Sorry, please enter the correct user name";
              }
        },
        error : function(data){
        document.getElementById("errmsg").innerHTML ="Sorry, please enter the correct user name";
