...
afyaApp.controller('TrainingScheduleController', ['$scope', '$http', '$window', function ($scope, $http, $window) {
        ...
        angular.element(document).ready(function(){
            ...
            if(username!= null){
                ...
                $http.get('/afya-portal/getPackageByUserOrGetAllPackagesForUserFacility').success(function(data){
                    console.log(data);
        ...
        $scope.setCurrentSchedule = function(package) {
            $scope.currentScheduleList = [];
            $http.get("/afya-portal/anon/getTrainingSessionSchedulesByPackageId?packageId="+package.packageId).success(function(data){
