...
afyaApp.controller('ConfirmationController', ['$scope', '$http','$stateParams','$state', function ($scope, $http,$stateParams, $state) {
    ...
    angular.element(document).ready(function () {
        ...
        $scope.clinicId = $stateParams.clinicId;// getParameterValueByProperty('clinicId');
        $scope.providerId = $stateParams.providerId;// getParameterValueByProperty('providerId');
        $scope.bookedOn = $stateParams.bookedOn;// getParameterValueByProperty('bookedOn');
        $scope.reason = $stateParams.notes;// getParameterValueByProperty('notes');
        $scope.patientName = $stateParams.pName;// getParameterValueByProperty('pName');
        //if($stateParams.type == 'AppointmentRequest')
        if($stateParams.type == 'ConsultVisit')
        ...
        if($scope.isRequest){
            ...
            $scope.successMsg = "Thanks for booking the appointment through AFYA";
        }
